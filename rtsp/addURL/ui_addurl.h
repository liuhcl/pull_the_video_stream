...
public:
    ...
    void setupUi(QWidget *addurl)
    {
        ...
        layoutWidget->setGeometry(QRect(80, 70, 661, 94));
...
""));
        ...
        widget = new QWidget(addurl);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(260, 540, 304, 42));
        horizontalLayout_4 = new QHBoxLayout(widget);
        horizontalLayout_4->setObjectName(QString::fromUtf8("horizontalLayout_4"));
        horizontalLayout_4->setContentsMargins(0, 0, 0, 0);
        delete_label = new QLabel(widget);
        ...
        horizontalLayout_4->addWidget(delete_label);

        deleteEdit = new QLineEdit(widget);
