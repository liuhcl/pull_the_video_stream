...
#include "../../../rtsp/mySerialPort/mySerialPort.h"
...
QT_MOC_LITERAL(1, 13, 17), // "getSerialPortData"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 8), // "uint8_t*"
QT_MOC_LITERAL(4, 41, 7) // "getdata"

    },
    "mySerialPort\0getSerialPortData\0\0"
    "uint8_t*\0getdata"
};
...
void mySerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getSerialPortData((*reinterpret_cast< uint8_t*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (mySerialPort::*)(uint8_t * , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mySerialPort::getSerialPortData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void mySerialPort::getSerialPortData(uint8_t * _t1, int _t2)
{
