...
#include "../../../rtsp/rtspUI/switchBtn/SwitchBtn.h"
...
void SwitchBtn::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SwitchBtn *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigClicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SwitchBtn::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SwitchBtn::sigClicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SwitchBtn::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_SwitchBtn.data,
    qt_meta_data_SwitchBtn,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void SwitchBtn::sigClicked(bool _t1)
{
